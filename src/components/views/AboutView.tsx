      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-theme-bg border border-theme-border p-6 sm:p-10 space-y-8 rounded-sm">
          ...
          <div className="text-center pb-6 border-b border-theme-border">
            ...
            <h1 className="font-serif text-3xl font-black text-theme-text mb-2">명리를 빌린 현대인의 수신서</h1>
            <p className="text-xs text-theme-secondary font-semibold italic">"사주는 미래의 낙인이 아닌, 나만의 인생 날씨 지도입니다."</p>
          </div>
