...
export default function HomeView({ navigate }: HomeViewProps) {
  ...
  return (
    <div className="bg-theme-bg font-sans min-h-screen text-theme-text select-none pb-12">
      ...
      <section className="relative overflow-hidden bg-theme-bg border-b border-theme-border py-16 sm:py-20 text-theme-text text-left">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="font-serif text-4xl sm:text-6xl font-black tracking-tight leading-[1.1] max-w-4xl mb-6 text-theme-text">
            당신의 생년월일시,<br />
            <span className="text-theme-accent font-serif font-black underline decoration-[4px] decoration-theme-border underline-offset-4">우주가 프로그래밍한 코드</span>를 해독합니다
          </h1>
          
          <p className="font-sans text-theme-secondary text-sm sm:text-base max-w-2xl mb-8 leading-relaxed font-semibold">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-theme-secondary text-[11px] font-medium leading-relaxed">
                  음양오행의 생극제화(生剋制化)라는 명확하고 균형 잡힌 원리로 삶의 수치를 해독하여 지적 만족을 드립니다.
                </p>
              </div>
            </div>
